package xyz.lazyrabbit.seata.order.util;
...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        tables.add("t_order");
        String outputDir = System.getProperty("user.dir") + "\\rabb-seata\\rabb-seata-order-service";
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/seata_order", "root", "123456")
